...
El array "segments" debe tener exactamente ${segmentCount} elementos.`),
  ...
  oscuro4d: {
    categories: [
      'leyenda latinoamericana', 'mitologia del mundo', 'criatura mitologica',
      'lugar maldito o embrujado', 'mito ancestral', 'misterio sin resolver',
      'ser sobrenatural', 'ritual o superstiticion antigua',
    ],
    ...
    categoryTags: {
      ...
      'mitologia del mundo': ['mitologia', 'dioses', 'mito antiguo'],
      'criatura mitologica': ['criatura', 'ser mitologico', 'bestia legendaria'],
      'lugar maldito o embrujado': ['lugar embrujado', 'sitio maldito', 'terror'],
      'mito ancestral': ['mito ancestral', 'leyenda antigua', 'tradicion'],
      'misterio sin resolver': ['misterio', 'enigma', 'sin resolver'],
      'ser sobrenatural': ['sobrenatural', 'aparicion', 'fantasma'],
      'ritual o superstiticion antigua': ['ritual', 'supersticion', 'creencia antigua'],
    },
...
Genera UN relato original y escalofriante de la categoria "${chosenCategory}".

Reglas del canal (CRITICAS):
- USA SIEMPRE lenguaje de leyenda: "cuentan que...", "se dice que...", "segun la leyenda...", "dicen los que viven ahi...". NUNCA afirmes hechos con fechas, nombres propios o datos como si fueran verificados. El miedo viene del misterio, no de afirmar que algo es real.
...
- GANCHO VISUAL (segmento 1, CRITICO): el visual_prompt del PRIMER segmento SIEMPRE debe mostrar una figura o presencia espectral inquietante vista A LO LEJOS o parcialmente oculta, que genere incertidumbre y frene el scroll. La clave: NO se ve por completo, esta lejana, entre niebla o sombras, de modo que el espectador no distingue bien que es. Ejemplos segun la leyenda: una silueta alta y deforme parada al final de un camino, una figura mitad animal mitad humana entre los arboles, una sombra con forma humana donde no deberia haber nadie, un ser encorvado a lo lejos en la niebla, dos ojos brillando en la oscuridad total, una figura espectral difusa observando desde lejos. SIEMPRE lejana, incompleta, insinuada, nunca en primer plano ni con rostro detallado (Agnes deforma los rostros cercanos). Debe describir la escena completa alrededor de la figura (el lugar, la niebla, la luz).
- Los demas visual_prompt deben ser escenas atmosfericas y concretas (niebla, bosques oscuros, siluetas lejanas, casas abandonadas, lunas, caminos de noche, objetos simbolicos), cinematograficas, sin rostros en primer plano deformables. Se pueden insinuar presencias lejanas o sombras inquietantes, pero nunca criaturas en primer plano. Nada de texto en la imagen.
