...
- GANCHO VISUAL (segmento 1, CRITICO): el visual_prompt del PRIMER segmento SIEMPRE debe mostrar la figura o presencia central DE ESTA leyenda especifica, vista A LO LEJOS o parcialmente oculta, que genere incertidumbre y frene el scroll. La figura DEBE corresponder a la criatura, ser o presencia que cuenta el relato (si la leyenda es de un ser alto y delgado, muestra esa silueta; si es mitad animal mitad humano, esa forma; si es un duende, un ser pequeño y encorvado; si es un espiritu, una figura difusa). La clave: NO se ve por completo, esta lejana, entre niebla o sombras, de modo que el espectador no distingue bien que es, pero coincide con lo que se va a narrar. SIEMPRE lejana, incompleta, insinuada, nunca en primer plano ni con rostro detallado (Agnes deforma los rostros cercanos). Debe describir la escena completa alrededor de la figura (el lugar, la niebla, la luz).
