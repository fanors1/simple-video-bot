...
async function generateScript({ category, segmentCount = 6, profile: profileName = DEFAULT_PROFILE, account = null } = {}) {
  ...
  // Antes los reels usaban solo 3 reintentos y las historias 6. Resultado:
  // cuando Agnes tenia un mal momento con un canal (chino, JSON roto, segmento
  // vacio), ese canal se quedaba sin publicar nada en los reels. Subimos a 6
  // para ambos: mas oportunidades = mucho menos probable que un canal falle.
