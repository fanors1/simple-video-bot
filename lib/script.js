...
- ESTILO VISUAL (TODOS los visual_prompt): foto-realista y cinematografico, escenas de esperanza y paz con estetica dorada y luz calida (amaneceres dorados, luz atravesando nubes o un bosque, un camino iluminado, manos abiertas hacia la luz, una vela encendida en la oscuridad, cielos, mar en calma al amanecer, montanas con luz divina). NUNCA representes a Dios, Jesus ni figuras sagradas en primer plano (por respeto). Sin rostros en primer plano. Nada de texto en la imagen.
